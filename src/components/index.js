...
export { default as Description } from './MainPage/Description'
export { default as Features } from './MainPage/Features'
export { default as Requirements } from './MainPage/Requirements'
